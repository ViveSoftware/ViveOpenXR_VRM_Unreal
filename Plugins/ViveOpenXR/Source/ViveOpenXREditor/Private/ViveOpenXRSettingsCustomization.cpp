...
void FViveOpenXRSettingsCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	SimultaneousInteractionCategory.AddCustomRow(LOCTEXT("SimultaneousInteractionUsageInfo", "Simultaneous Interaction Info"), false)
		.WholeRowWidget
		[
			SNew(SBorder)
			.Padding(1)
			[
				...
				[
					SNew(SRichTextBlock)
					.Text(LOCTEXT("SimultaneousInteractionUsageInfoMessage",
